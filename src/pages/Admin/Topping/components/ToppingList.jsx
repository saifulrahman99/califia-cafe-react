...
const ToppingList = () => {
    ...
    useEffect(() => {
        ...
        const getToppings = async () => {
            try {
                const response = await toppingService.getAll({ q });
        ...
        <>
            <div className="p-4 rounded bg-white border border-slate-200">
                ...
                <div className="flex items-center mt-2 justify-end">
                    <div className="search-box flex items-center gap-x-2 border-2 border-slate-300 rounded-lg py-2 px-2 focus-within:border-amber-500">
                ...
                <div className="overflow-x-auto overflow-y-auto min-h-[20rem] h-[30rem] max-w-[100vw] thin-scrollbar py-4">
                    <table className="w-full divide-y divide-gray-200">
                        ...
                        <tbody className="bg-white divide-y divide-gray-200">
                            {isLoading ? (
                                <tr><td className="px-4 py-2" colSpan={6}>Loading...</td></tr>
                            ) : toppings.length > 0 ? (
                                ...
                                <tr><td colSpan={6} className="text-center py-4">Tidak ada topping untuk ditampilkan</td></tr>
                            )}
                        </tbody>
                    </table>
                </div>
